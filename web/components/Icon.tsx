...
/**
 * Inline stroke icons (Lucide-style paths) so the app needs no icon
 * dependency. Every icon inherits `currentColor` and sizes from the
 * `size` prop. Add a new glyph by dropping its path(s) into PATHS.
 */
